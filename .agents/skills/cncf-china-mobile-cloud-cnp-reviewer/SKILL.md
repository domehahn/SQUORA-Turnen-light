---
name: "cncf-china-mobile-cloud-cnp-reviewer"
description: "Review China Mobile Cloud CNP using its official documentation and repository in the Orchestration & Management / Scheduling & Orchestration category. China Mobile Cloud CNP is an application management platform for multi-cluster and multi-cloud scenarios."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf China Mobile Cloud Cnp Reviewer

## Purpose

Review and operate China Mobile Cloud CNP using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- China Mobile Cloud CNP code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving China Mobile Cloud CNP requires evidence-backed assessment.
...
- First-party source: https://ecloud.10086.cn/home/product-introduction/CNP
...
- [ ] Trace China Mobile Cloud CNP inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check China Mobile Cloud CNP defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check China Mobile Cloud CNP least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check China Mobile Cloud CNP resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check China Mobile Cloud CNP release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check China Mobile Cloud CNP dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If China Mobile Cloud CNP identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a China Mobile Cloud CNP change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- China Mobile Cloud CNP documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a China Mobile Cloud CNP architecture and dependency summary with trust boundaries and persistent state.
- Include China Mobile Cloud CNP validation commands or tests that are safe for the stated environment.
...
- China Mobile Cloud CNP identity, version, configuration, dependencies, and deployment assumptions are explicit.
- China Mobile Cloud CNP failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that China Mobile Cloud CNP is secure, supported, compatible, or suitable.
- Using an unpinned latest version of China Mobile Cloud CNP as the basis for migration or production guidance.
