...
---
# Cncf Mia Platform Reviewer

## Purpose

Review and operate Mia-Platform using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Mia-Platform code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Mia-Platform requires evidence-backed assessment.
...
- First-party source: https://mia-platform.eu
...
- [ ] Trace Mia-Platform inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Mia-Platform defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Mia-Platform least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Mia-Platform resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Mia-Platform release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Mia-Platform dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Mia-Platform identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Mia-Platform change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Mia-Platform documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Mia-Platform architecture and dependency summary with trust boundaries and persistent state.
- Include Mia-Platform validation commands or tests that are safe for the stated environment.
...
- Mia-Platform identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Mia-Platform failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Mia-Platform is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Mia-Platform as the basis for migration or production guidance.
