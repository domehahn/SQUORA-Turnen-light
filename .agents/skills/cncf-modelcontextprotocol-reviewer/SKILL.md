---
name: "cncf-modelcontextprotocol-reviewer"
description: "Review Modelcontextprotocol using its official documentation and repository in the AI Agent / Protocol category. Specification and documentation for the Model Context Protocol."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Modelcontextprotocol Reviewer

## Purpose

Review and operate Modelcontextprotocol using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Modelcontextprotocol code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Modelcontextprotocol requires evidence-backed assessment.
...
- CNCF classification: AI Agent / Protocol
- CNCF project maturity field: not specified
- First-party source: https://github.com/modelcontextprotocol/modelcontextprotocol
...
- [ ] Trace Modelcontextprotocol inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Modelcontextprotocol defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Modelcontextprotocol least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Modelcontextprotocol resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Modelcontextprotocol release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Modelcontextprotocol dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Modelcontextprotocol identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Modelcontextprotocol change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Modelcontextprotocol documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Modelcontextprotocol architecture and dependency summary with trust boundaries and persistent state.
- Include Modelcontextprotocol validation commands or tests that are safe for the stated environment.
...
- Modelcontextprotocol identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Modelcontextprotocol failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Modelcontextprotocol is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Modelcontextprotocol as the basis for migration or production guidance.
