---
name: "cncf-open-policy-containers-reviewer"
description: "Review Open Policy Containers using its official documentation and repository in the Provisioning / Security & Compliance category. A docker-inspired CLI for building, tagging, pushing, pulling, and signing OPA policies to and from OCI-compliant registries."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Open Policy Containers Reviewer

## Purpose

Review and operate Open Policy Containers using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Open Policy Containers code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Open Policy Containers requires evidence-backed assessment.
...
- First-party source: https://github.com/opcr-io/policy
...
- [ ] Trace Open Policy Containers inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Open Policy Containers defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Open Policy Containers least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Open Policy Containers resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Open Policy Containers release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Open Policy Containers dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Open Policy Containers identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Open Policy Containers change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Open Policy Containers documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Open Policy Containers architecture and dependency summary with trust boundaries and persistent state.
- Include Open Policy Containers validation commands or tests that are safe for the stated environment.
...
- Open Policy Containers identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Open Policy Containers failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Open Policy Containers is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Open Policy Containers as the basis for migration or production guidance.
