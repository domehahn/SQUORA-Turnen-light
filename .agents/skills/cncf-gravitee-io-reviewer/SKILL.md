---
name: "cncf-gravitee-io-reviewer"
description: "Review Gravitee.io using its official documentation and repository in the Orchestration & Management / API Gateway category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Gravitee Io Reviewer

## Purpose

Review and operate Gravitee.io using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Gravitee.io code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Gravitee.io requires evidence-backed assessment.
...
- First-party source: https://github.com/gravitee-io/gravitee-api-management
...
- [ ] Trace Gravitee.io inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Gravitee.io defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Gravitee.io least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Gravitee.io resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Gravitee.io release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Gravitee.io dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Gravitee.io identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Gravitee.io change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Gravitee.io documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Gravitee.io architecture and dependency summary with trust boundaries and persistent state.
- Include Gravitee.io validation commands or tests that are safe for the stated environment.
...
- Gravitee.io identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Gravitee.io failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Gravitee.io is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Gravitee.io as the basis for migration or production guidance.
