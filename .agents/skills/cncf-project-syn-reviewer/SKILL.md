---
name: "cncf-project-syn-reviewer"
description: "Review Project Syn using its official documentation and repository in the Provisioning / Automation & Configuration category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Project Syn Reviewer

## Purpose

Review and operate Project Syn using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Project Syn code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Project Syn requires evidence-backed assessment.
...
- First-party source: https://github.com/projectsyn/commodore
...
- [ ] Trace Project Syn inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Project Syn defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Project Syn least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Project Syn resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Project Syn release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Project Syn dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Project Syn identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Project Syn change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Project Syn documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Project Syn architecture and dependency summary with trust boundaries and persistent state.
- Include Project Syn validation commands or tests that are safe for the stated environment.
...
- Project Syn identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Project Syn failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Project Syn is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Project Syn as the basis for migration or production guidance.
