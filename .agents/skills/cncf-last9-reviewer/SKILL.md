---
name: "cncf-last9-reviewer"
description: "Review Last9 using its official documentation and repository in the Observability and Analysis / Observability category."
version: "1.0.0"
since: "2026-08-27"
...
Review and operate Last9 using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Last9 code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Last9 requires evidence-backed assessment.
...
- First-party source: https://last9.io
...
- [ ] Trace Last9 inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Last9 defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Last9 least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Last9 resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Last9 release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Last9 dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Last9 identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Last9 change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Last9 documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Last9 architecture and dependency summary with trust boundaries and persistent state.
- Include Last9 validation commands or tests that are safe for the stated environment.
...
- Last9 identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Last9 failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Last9 is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Last9 as the basis for migration or production guidance.
