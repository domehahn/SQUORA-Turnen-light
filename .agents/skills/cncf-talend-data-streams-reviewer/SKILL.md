---
name: "cncf-talend-data-streams-reviewer"
description: "Review Talend Data Streams using its official documentation and repository in the App Definition and Development / Streaming & Messaging category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Talend Data Streams Reviewer

## Purpose

Review and operate Talend Data Streams using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Talend Data Streams code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Talend Data Streams requires evidence-backed assessment.
...
- First-party source: https://www.talend.com/resources/what-streaming-data
...
- [ ] Trace Talend Data Streams inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Talend Data Streams defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Talend Data Streams least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Talend Data Streams resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Talend Data Streams release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Talend Data Streams dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Talend Data Streams identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Talend Data Streams change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Talend Data Streams documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Talend Data Streams architecture and dependency summary with trust boundaries and persistent state.
- Include Talend Data Streams validation commands or tests that are safe for the stated environment.
...
- Talend Data Streams identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Talend Data Streams failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Talend Data Streams is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Talend Data Streams as the basis for migration or production guidance.
