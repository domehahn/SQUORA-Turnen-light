---
name: "cncf-powerfulseal-reviewer"
description: "Review PowerfulSeal using its official documentation and repository in the Observability and Analysis / Chaos Engineering category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Powerfulseal Reviewer

## Purpose

Review and operate PowerfulSeal using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- PowerfulSeal code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving PowerfulSeal requires evidence-backed assessment.
...
- First-party source: https://github.com/powerfulseal/powerfulseal
...
- [ ] Trace PowerfulSeal inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check PowerfulSeal defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check PowerfulSeal least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check PowerfulSeal resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check PowerfulSeal release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check PowerfulSeal dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If PowerfulSeal identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a PowerfulSeal change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- PowerfulSeal documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a PowerfulSeal architecture and dependency summary with trust boundaries and persistent state.
- Include PowerfulSeal validation commands or tests that are safe for the stated environment.
...
- PowerfulSeal identity, version, configuration, dependencies, and deployment assumptions are explicit.
- PowerfulSeal failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that PowerfulSeal is secure, supported, compatible, or suitable.
- Using an unpinned latest version of PowerfulSeal as the basis for migration or production guidance.
