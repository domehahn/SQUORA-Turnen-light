...
---
# Cncf Alibaba Cloud Application Real Time Service Reviewer

## Purpose

Review and operate Alibaba Cloud Application Real-Time Service using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Alibaba Cloud Application Real-Time Service code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Alibaba Cloud Application Real-Time Service requires evidence-backed assessment.
...
- CNCF classification: Observability and Analysis / Observability
- CNCF project maturity field: not specified
- First-party source: https://www.alibabacloud.com/product/arms
...
- [ ] Trace Alibaba Cloud Application Real-Time Service inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Alibaba Cloud Application Real-Time Service defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Alibaba Cloud Application Real-Time Service least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Alibaba Cloud Application Real-Time Service resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Alibaba Cloud Application Real-Time Service release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Alibaba Cloud Application Real-Time Service dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Alibaba Cloud Application Real-Time Service identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Alibaba Cloud Application Real-Time Service change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Alibaba Cloud Application Real-Time Service documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Alibaba Cloud Application Real-Time Service architecture and dependency summary with trust boundaries and persistent state.
- Include Alibaba Cloud Application Real-Time Service validation commands or tests that are safe for the stated environment.
...
- Alibaba Cloud Application Real-Time Service identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Alibaba Cloud Application Real-Time Service failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Alibaba Cloud Application Real-Time Service is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Alibaba Cloud Application Real-Time Service as the basis for migration or production guidance.
