...
---
# Cncf Red Hat Openshift On Ibm Cloud Reviewer

## Purpose

Review and operate Red Hat OpenShift on IBM Cloud using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Red Hat OpenShift on IBM Cloud code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Red Hat OpenShift on IBM Cloud requires evidence-backed assessment.
...
- First-party source: https://www.ibm.com/cloud/openshift
...
- [ ] Trace Red Hat OpenShift on IBM Cloud inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Red Hat OpenShift on IBM Cloud defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Red Hat OpenShift on IBM Cloud least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Red Hat OpenShift on IBM Cloud resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Red Hat OpenShift on IBM Cloud release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Red Hat OpenShift on IBM Cloud dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Red Hat OpenShift on IBM Cloud identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Red Hat OpenShift on IBM Cloud change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Red Hat OpenShift on IBM Cloud documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Red Hat OpenShift on IBM Cloud architecture and dependency summary with trust boundaries and persistent state.
- Include Red Hat OpenShift on IBM Cloud validation commands or tests that are safe for the stated environment.
...
- Red Hat OpenShift on IBM Cloud identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Red Hat OpenShift on IBM Cloud failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Red Hat OpenShift on IBM Cloud is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Red Hat OpenShift on IBM Cloud as the basis for migration or production guidance.
