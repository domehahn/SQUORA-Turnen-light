---
name: "cncf-pydantic-ai-reviewer"
description: "Review Pydantic AI using its official documentation and repository in the AI Agent / Agent Framework category. AI Agent Framework, the Pydantic way"
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Pydantic Ai Reviewer

## Purpose

Review and operate Pydantic AI using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Pydantic AI code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Pydantic AI requires evidence-backed assessment.
...
- First-party source: https://github.com/pydantic/pydantic-ai
...
- [ ] Trace Pydantic AI inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Pydantic AI defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Pydantic AI least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Pydantic AI resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Pydantic AI release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Pydantic AI dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Pydantic AI identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Pydantic AI change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Pydantic AI documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Pydantic AI architecture and dependency summary with trust boundaries and persistent state.
- Include Pydantic AI validation commands or tests that are safe for the stated environment.
...
- Pydantic AI identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Pydantic AI failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Pydantic AI is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Pydantic AI as the basis for migration or production guidance.
