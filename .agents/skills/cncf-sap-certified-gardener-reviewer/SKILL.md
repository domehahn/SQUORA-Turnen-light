---
name: "cncf-sap-certified-gardener-reviewer"
description: "Review SAP Certified Gardener using its official documentation and repository in the Platform / Certified Kubernetes - Hosted category. The Gardener implements automated management and operation of Kubernetes clusters as a service and aims to support that service on multiple Cloud providers."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Sap Certified Gardener Reviewer

## Purpose

Review and operate SAP Certified Gardener using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- SAP Certified Gardener code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving SAP Certified Gardener requires evidence-backed assessment.
...
- First-party source: https://www.sap.com/products/cloud-platform.html
...
- [ ] Trace SAP Certified Gardener inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check SAP Certified Gardener defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check SAP Certified Gardener least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check SAP Certified Gardener resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check SAP Certified Gardener release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check SAP Certified Gardener dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If SAP Certified Gardener identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a SAP Certified Gardener change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- SAP Certified Gardener documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a SAP Certified Gardener architecture and dependency summary with trust boundaries and persistent state.
- Include SAP Certified Gardener validation commands or tests that are safe for the stated environment.
...
- SAP Certified Gardener identity, version, configuration, dependencies, and deployment assumptions are explicit.
- SAP Certified Gardener failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that SAP Certified Gardener is secure, supported, compatible, or suitable.
- Using an unpinned latest version of SAP Certified Gardener as the basis for migration or production guidance.
