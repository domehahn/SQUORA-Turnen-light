...
---
# Cncf China Mobile Panji Paas Platform Reviewer

## Purpose

Review and operate China Mobile Panji PaaS Platform using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- China Mobile Panji PaaS Platform code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving China Mobile Panji PaaS Platform requires evidence-backed assessment.
...
- CNCF classification: Orchestration & Management / Scheduling & Orchestration
- CNCF project maturity field: not specified
- First-party source: https://it.10086.cn/services/paas/
...
- [ ] Trace China Mobile Panji PaaS Platform inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check China Mobile Panji PaaS Platform defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check China Mobile Panji PaaS Platform least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check China Mobile Panji PaaS Platform resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check China Mobile Panji PaaS Platform release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check China Mobile Panji PaaS Platform dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If China Mobile Panji PaaS Platform identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a China Mobile Panji PaaS Platform change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- China Mobile Panji PaaS Platform documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a China Mobile Panji PaaS Platform architecture and dependency summary with trust boundaries and persistent state.
- Include China Mobile Panji PaaS Platform validation commands or tests that are safe for the stated environment.
...
- China Mobile Panji PaaS Platform identity, version, configuration, dependencies, and deployment assumptions are explicit.
- China Mobile Panji PaaS Platform failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that China Mobile Panji PaaS Platform is secure, supported, compatible, or suitable.
- Using an unpinned latest version of China Mobile Panji PaaS Platform as the basis for migration or production guidance.
