---
name: "cncf-ejbca-community-reviewer"
description: "Review EJBCA Community using its official documentation and repository in the Provisioning / Security & Compliance category. Issue certificates for all your Kubernetes workloads with the open-source public key infrastructure (PKI) and certificate authority (CA) software EJBCA."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Ejbca Community Reviewer

## Purpose

Review and operate EJBCA Community using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- EJBCA Community code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving EJBCA Community requires evidence-backed assessment.
...
- First-party source: https://github.com/Keyfactor/ejbca-ce
...
- [ ] Trace EJBCA Community inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check EJBCA Community defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check EJBCA Community least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check EJBCA Community resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check EJBCA Community release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check EJBCA Community dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If EJBCA Community identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a EJBCA Community change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- EJBCA Community documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a EJBCA Community architecture and dependency summary with trust boundaries and persistent state.
- Include EJBCA Community validation commands or tests that are safe for the stated environment.
...
- EJBCA Community identity, version, configuration, dependencies, and deployment assumptions are explicit.
- EJBCA Community failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that EJBCA Community is secure, supported, compatible, or suitable.
- Using an unpinned latest version of EJBCA Community as the basis for migration or production guidance.
