---
name: "cncf-project-jupyter-reviewer"
description: "Review Project Jupyter using its official documentation and repository in the Data / Data Science category. Interactive Computing"
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Project Jupyter Reviewer

## Purpose

Review and operate Project Jupyter using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Project Jupyter code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Project Jupyter requires evidence-backed assessment.
...
- First-party source: https://github.com/jupyter/jupyter
...
- [ ] Trace Project Jupyter inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Project Jupyter defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Project Jupyter least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Project Jupyter resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Project Jupyter release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Project Jupyter dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Project Jupyter identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Project Jupyter change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Project Jupyter documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Project Jupyter architecture and dependency summary with trust boundaries and persistent state.
- Include Project Jupyter validation commands or tests that are safe for the stated environment.
...
- Project Jupyter identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Project Jupyter failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Project Jupyter is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Project Jupyter as the basis for migration or production guidance.
