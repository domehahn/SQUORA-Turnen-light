---
name: "cncf-capsule8-reviewer"
description: "Review Capsule8 using its official documentation and repository in the Provisioning / Security & Compliance category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Capsule8 Reviewer

## Purpose

Review and operate Capsule8 using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Capsule8 code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Capsule8 requires evidence-backed assessment.
...
- First-party source: https://capsule8.com/
...
- [ ] Trace Capsule8 inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Capsule8 defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Capsule8 least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Capsule8 resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Capsule8 release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Capsule8 dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Capsule8 identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Capsule8 change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Capsule8 documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Capsule8 architecture and dependency summary with trust boundaries and persistent state.
- Include Capsule8 validation commands or tests that are safe for the stated environment.
...
- Capsule8 identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Capsule8 failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Capsule8 is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Capsule8 as the basis for migration or production guidance.
