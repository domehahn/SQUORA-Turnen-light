---
name: "cncf-metal3-io-reviewer"
description: "Review metal3-io using its official documentation and repository in the Provisioning / Automation & Configuration category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Metal3 Io Reviewer

## Purpose

Review and operate metal3-io using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- metal3-io code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving metal3-io requires evidence-backed assessment.
...
- First-party source: https://github.com/metal3-io/baremetal-operator
...
- [ ] Trace metal3-io inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check metal3-io defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check metal3-io least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check metal3-io resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check metal3-io release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check metal3-io dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If metal3-io identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a metal3-io change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- metal3-io documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a metal3-io architecture and dependency summary with trust boundaries and persistent state.
- Include metal3-io validation commands or tests that are safe for the stated environment.
...
- metal3-io identity, version, configuration, dependencies, and deployment assumptions are explicit.
- metal3-io failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that metal3-io is secure, supported, compatible, or suitable.
- Using an unpinned latest version of metal3-io as the basis for migration or production guidance.
