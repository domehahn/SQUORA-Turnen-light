---
name: "cncf-componentize-js-reviewer"
description: "Review componentize-js using its official documentation and repository in the Wasm / Languages category. Scripting languages that support Wasm"
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Componentize Js Reviewer

## Purpose

Review and operate componentize-js using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- componentize-js code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving componentize-js requires evidence-backed assessment.
...
- First-party source: https://github.com/bytecodealliance/ComponentizeJS
...
- [ ] Trace componentize-js inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check componentize-js defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check componentize-js least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check componentize-js resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check componentize-js release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check componentize-js dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If componentize-js identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a componentize-js change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- componentize-js documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a componentize-js architecture and dependency summary with trust boundaries and persistent state.
- Include componentize-js validation commands or tests that are safe for the stated environment.
...
- componentize-js identity, version, configuration, dependencies, and deployment assumptions are explicit.
- componentize-js failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that componentize-js is secure, supported, compatible, or suitable.
- Using an unpinned latest version of componentize-js as the basis for migration or production guidance.
