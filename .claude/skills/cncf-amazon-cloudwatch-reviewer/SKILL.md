---
name: "cncf-amazon-cloudwatch-reviewer"
description: "Review Amazon CloudWatch using its official documentation and repository in the Observability and Analysis / Observability category. Amazon CloudWatch is a monitoring and management service built for developers, system operators, site reliability engineers (SRE), and IT managers. CloudWatch provides you with data and actionable insights to monitor your applications, understand and respond to system-wide performance changes, optimize resource utilization, and get a unified view of operational health."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Amazon Cloudwatch Reviewer

## Purpose

Review and operate Amazon CloudWatch using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Amazon CloudWatch code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Amazon CloudWatch requires evidence-backed assessment.
...
- First-party source: https://aws.amazon.com/cloudwatch/
...
- [ ] Trace Amazon CloudWatch inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Amazon CloudWatch defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Amazon CloudWatch least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Amazon CloudWatch resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Amazon CloudWatch release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Amazon CloudWatch dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Amazon CloudWatch identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Amazon CloudWatch change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Amazon CloudWatch documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Amazon CloudWatch architecture and dependency summary with trust boundaries and persistent state.
- Include Amazon CloudWatch validation commands or tests that are safe for the stated environment.
...
- Amazon CloudWatch identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Amazon CloudWatch failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Amazon CloudWatch is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Amazon CloudWatch as the basis for migration or production guidance.
