---
name: "cncf-crew-ai-reviewer"
description: "Review Crew AI using its official documentation and repository in the AI Agent / Agent Framework category. Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Crew Ai Reviewer

## Purpose

Review and operate Crew AI using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Crew AI code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Crew AI requires evidence-backed assessment.
...
- First-party source: https://github.com/crewAIInc/crewAI
...
- [ ] Trace Crew AI inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Crew AI defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Crew AI least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Crew AI resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Crew AI release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Crew AI dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Crew AI identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Crew AI change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Crew AI documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Crew AI architecture and dependency summary with trust boundaries and persistent state.
- Include Crew AI validation commands or tests that are safe for the stated environment.
...
- Crew AI identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Crew AI failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Crew AI is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Crew AI as the basis for migration or production guidance.
