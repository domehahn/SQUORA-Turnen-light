---
name: "cncf-pandora2-0-reviewer"
description: "Review Pandora2.0 using its official documentation and repository in the Observability and Analysis / Observability category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Pandora2 0 Reviewer

## Purpose

Review and operate Pandora2.0 using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Pandora2.0 code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Pandora2.0 requires evidence-backed assessment.
...
- First-party source: https://www.qiniu.com/products/pdr
...
- [ ] Trace Pandora2.0 inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Pandora2.0 defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Pandora2.0 least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Pandora2.0 resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Pandora2.0 release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Pandora2.0 dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Pandora2.0 identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Pandora2.0 change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Pandora2.0 documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Pandora2.0 architecture and dependency summary with trust boundaries and persistent state.
- Include Pandora2.0 validation commands or tests that are safe for the stated environment.
...
- Pandora2.0 identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Pandora2.0 failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Pandora2.0 is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Pandora2.0 as the basis for migration or production guidance.
