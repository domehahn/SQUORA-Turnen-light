---
name: "cncf-red-hat-openshift-dedicated-reviewer"
description: "Review Red Hat OpenShift Dedicated using its official documentation and repository in the Platform / Certified Kubernetes - Hosted category. OpenShift® Dedicated helps organizations focus on building and scaling their business with a private Kubernetes cluster fully-managed by Red Hat®."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Red Hat Openshift Dedicated Reviewer

## Purpose

Review and operate Red Hat OpenShift Dedicated using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Red Hat OpenShift Dedicated code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Red Hat OpenShift Dedicated requires evidence-backed assessment.
...
- First-party source: https://cloud.redhat.com/products/dedicated
...
- [ ] Trace Red Hat OpenShift Dedicated inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Red Hat OpenShift Dedicated defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Red Hat OpenShift Dedicated least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Red Hat OpenShift Dedicated resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Red Hat OpenShift Dedicated release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Red Hat OpenShift Dedicated dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Red Hat OpenShift Dedicated identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Red Hat OpenShift Dedicated change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Red Hat OpenShift Dedicated documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Red Hat OpenShift Dedicated architecture and dependency summary with trust boundaries and persistent state.
- Include Red Hat OpenShift Dedicated validation commands or tests that are safe for the stated environment.
...
- Red Hat OpenShift Dedicated identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Red Hat OpenShift Dedicated failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Red Hat OpenShift Dedicated is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Red Hat OpenShift Dedicated as the basis for migration or production guidance.
