---
name: "cncf-chaitin-tech-reviewer"
description: "Review Chaitin Tech using its official documentation and repository in the Provisioning / Security & Compliance category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Chaitin Tech Reviewer

## Purpose

Review and operate Chaitin Tech using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Chaitin Tech code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Chaitin Tech requires evidence-backed assessment.
...
- First-party source: https://www.chaitin.cn/en/
...
- [ ] Trace Chaitin Tech inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Chaitin Tech defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Chaitin Tech least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Chaitin Tech resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Chaitin Tech release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Chaitin Tech dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Chaitin Tech identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Chaitin Tech change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Chaitin Tech documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Chaitin Tech architecture and dependency summary with trust boundaries and persistent state.
- Include Chaitin Tech validation commands or tests that are safe for the stated environment.
...
- Chaitin Tech identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Chaitin Tech failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Chaitin Tech is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Chaitin Tech as the basis for migration or production guidance.
