---
name: "cncf-nightingale-reviewer"
description: "Review Nightingale using its official documentation and repository in the Observability and Analysis / Observability category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Nightingale Reviewer

## Purpose

Review and operate Nightingale using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Nightingale code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Nightingale requires evidence-backed assessment.
...
- First-party source: https://github.com/didi/nightingale
...
- [ ] Trace Nightingale inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Nightingale defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Nightingale least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Nightingale resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Nightingale release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Nightingale dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Nightingale identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Nightingale change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Nightingale documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Nightingale architecture and dependency summary with trust boundaries and persistent state.
- Include Nightingale validation commands or tests that are safe for the stated environment.
...
- Nightingale identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Nightingale failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Nightingale is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Nightingale as the basis for migration or production guidance.
