---
name: "cncf-notary-project-reviewer"
description: "Review Notary Project using its official documentation and repository in the Provisioning / Security & Compliance category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Notary Project Reviewer

## Purpose

Review and operate Notary Project using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Notary Project code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Notary Project requires evidence-backed assessment.
...
- First-party source: https://github.com/notaryproject/notation
...
- [ ] Trace Notary Project inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Notary Project defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Notary Project least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Notary Project resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Notary Project release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Notary Project dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Notary Project identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Notary Project change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Notary Project documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Notary Project architecture and dependency summary with trust boundaries and persistent state.
- Include Notary Project validation commands or tests that are safe for the stated environment.
...
- Notary Project identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Notary Project failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Notary Project is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Notary Project as the basis for migration or production guidance.
