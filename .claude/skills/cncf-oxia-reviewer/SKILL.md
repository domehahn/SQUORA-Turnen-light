---
name: "cncf-oxia-reviewer"
description: "Review Oxia using its official documentation and repository in the Orchestration & Management / Coordination & Service Discovery category. Oxia is a scalable metadata store and coordination system"
version: "1.0.0"
since: "2026-08-27"
...
Review and operate Oxia using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Oxia code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Oxia requires evidence-backed assessment.
...
- First-party source: https://github.com/oxia-db/oxia
...
- [ ] Trace Oxia inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Oxia defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Oxia least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Oxia resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Oxia release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Oxia dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Oxia identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Oxia change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Oxia documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Oxia architecture and dependency summary with trust boundaries and persistent state.
- Include Oxia validation commands or tests that are safe for the stated environment.
...
- Oxia identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Oxia failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Oxia is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Oxia as the basis for migration or production guidance.
