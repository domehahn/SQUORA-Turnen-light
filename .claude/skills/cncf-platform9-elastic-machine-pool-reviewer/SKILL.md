...
---
# Cncf Platform9 Elastic Machine Pool Reviewer

## Purpose

Review and operate Platform9 Elastic Machine Pool using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Platform9 Elastic Machine Pool code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Platform9 Elastic Machine Pool requires evidence-backed assessment.
...
- First-party source: https://platform9.com/elastic-machine-pool/
...
- [ ] Trace Platform9 Elastic Machine Pool inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Platform9 Elastic Machine Pool defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Platform9 Elastic Machine Pool least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Platform9 Elastic Machine Pool resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Platform9 Elastic Machine Pool release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Platform9 Elastic Machine Pool dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Platform9 Elastic Machine Pool identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Platform9 Elastic Machine Pool change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Platform9 Elastic Machine Pool documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Platform9 Elastic Machine Pool architecture and dependency summary with trust boundaries and persistent state.
- Include Platform9 Elastic Machine Pool validation commands or tests that are safe for the stated environment.
...
- Platform9 Elastic Machine Pool identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Platform9 Elastic Machine Pool failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Platform9 Elastic Machine Pool is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Platform9 Elastic Machine Pool as the basis for migration or production guidance.
