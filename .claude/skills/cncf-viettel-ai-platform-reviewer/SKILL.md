...
---
# Cncf Viettel Ai Platform Reviewer

## Purpose

Review and operate Viettel AI Platform using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Viettel AI Platform code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Viettel AI Platform requires evidence-backed assessment.
...
- [ ] Trace Viettel AI Platform inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Viettel AI Platform defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Viettel AI Platform least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Viettel AI Platform resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Viettel AI Platform release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Viettel AI Platform dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Viettel AI Platform identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Viettel AI Platform change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Viettel AI Platform documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Viettel AI Platform architecture and dependency summary with trust boundaries and persistent state.
- Include Viettel AI Platform validation commands or tests that are safe for the stated environment.
...
- Viettel AI Platform identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Viettel AI Platform failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Viettel AI Platform is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Viettel AI Platform as the basis for migration or production guidance.
