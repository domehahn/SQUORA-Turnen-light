---
name: "cncf-standard-library-reviewer"
description: "Review Standard Library using its official documentation and repository in the Serverless / Hosted Platform category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Standard Library Reviewer

## Purpose

Review and operate Standard Library using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Standard Library code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Standard Library requires evidence-backed assessment.
...
- First-party source: https://autocode.com
...
- [ ] Trace Standard Library inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Standard Library defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Standard Library least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Standard Library resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Standard Library release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Standard Library dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Standard Library identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Standard Library change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Standard Library documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Standard Library architecture and dependency summary with trust boundaries and persistent state.
- Include Standard Library validation commands or tests that are safe for the stated environment.
...
- Standard Library identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Standard Library failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Standard Library is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Standard Library as the basis for migration or production guidance.
