---
name: "cncf-harness-io-reviewer"
description: "Review Harness.io using its official documentation and repository in the App Definition and Development / Continuous Integration & Delivery category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Harness Io Reviewer

## Purpose

Review and operate Harness.io using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Harness.io code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Harness.io requires evidence-backed assessment.
...
- [ ] Trace Harness.io inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Harness.io defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Harness.io least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Harness.io resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Harness.io release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Harness.io dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Harness.io identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Harness.io change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Harness.io documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Harness.io architecture and dependency summary with trust boundaries and persistent state.
- Include Harness.io validation commands or tests that are safe for the stated environment.
...
- Harness.io identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Harness.io failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Harness.io is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Harness.io as the basis for migration or production guidance.
