---
name: "cncf-microsoft-sql-server-reviewer"
description: "Review Microsoft SQL Server using its official documentation and repository in the App Definition and Development / Database category. Data-Driven. Faster Insights. Breakthrough Performance. In-Memory Technology. Hybrid Data Platform."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Microsoft Sql Server Reviewer

## Purpose

Review and operate Microsoft SQL Server using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Microsoft SQL Server code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Microsoft SQL Server requires evidence-backed assessment.
...
- First-party source: https://www.microsoft.com/en-us/sql-server
...
- [ ] Trace Microsoft SQL Server inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Microsoft SQL Server defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Microsoft SQL Server least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Microsoft SQL Server resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Microsoft SQL Server release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Microsoft SQL Server dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Microsoft SQL Server identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Microsoft SQL Server change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Microsoft SQL Server documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Microsoft SQL Server architecture and dependency summary with trust boundaries and persistent state.
- Include Microsoft SQL Server validation commands or tests that are safe for the stated environment.
...
- Microsoft SQL Server identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Microsoft SQL Server failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Microsoft SQL Server is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Microsoft SQL Server as the basis for migration or production guidance.
