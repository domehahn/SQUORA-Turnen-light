---
name: "cncf-bank-vaults-reviewer"
description: "Review Bank-Vaults using its official documentation and repository in the Provisioning / Security & Compliance category. Bank-Vaults is a Vault swiss-army knife: a K8s operator, Go client with automatic token renewal, automatic configuration, multiple unseal options and more. A CLI tool to init, unseal and configure Vault (auth methods, secret engines). Direct secret injection into Pods."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Bank Vaults Reviewer

## Purpose

Review and operate Bank-Vaults using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Bank-Vaults code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Bank-Vaults requires evidence-backed assessment.
...
- First-party source: https://github.com/bank-vaults/bank-vaults
...
- [ ] Trace Bank-Vaults inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Bank-Vaults defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Bank-Vaults least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Bank-Vaults resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Bank-Vaults release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Bank-Vaults dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Bank-Vaults identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Bank-Vaults change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Bank-Vaults documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Bank-Vaults architecture and dependency summary with trust boundaries and persistent state.
- Include Bank-Vaults validation commands or tests that are safe for the stated environment.
...
- Bank-Vaults identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Bank-Vaults failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Bank-Vaults is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Bank-Vaults as the basis for migration or production guidance.
