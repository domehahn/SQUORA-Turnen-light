---
name: "cncf-prisma-cloud-by-palo-alto-networks-reviewer"
description: "Review Prisma Cloud by Palo Alto Networks using its official documentation and repository in the Serverless / Security category."
version: "1.0.0"
since: "2026-08-27"
...
---
# Cncf Prisma Cloud By Palo Alto Networks Reviewer

## Purpose

Review and operate Prisma Cloud by Palo Alto Networks using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Prisma Cloud by Palo Alto Networks code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Prisma Cloud by Palo Alto Networks requires evidence-backed assessment.
...
- CNCF classification: Serverless / Security
- CNCF project maturity field: not specified
- First-party source: https://www.paloaltonetworks.com/prisma/cloud
...
- [ ] Trace Prisma Cloud by Palo Alto Networks inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Prisma Cloud by Palo Alto Networks defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Prisma Cloud by Palo Alto Networks least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Prisma Cloud by Palo Alto Networks resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Prisma Cloud by Palo Alto Networks release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Prisma Cloud by Palo Alto Networks dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Prisma Cloud by Palo Alto Networks identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Prisma Cloud by Palo Alto Networks change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Prisma Cloud by Palo Alto Networks documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Prisma Cloud by Palo Alto Networks architecture and dependency summary with trust boundaries and persistent state.
- Include Prisma Cloud by Palo Alto Networks validation commands or tests that are safe for the stated environment.
...
- Prisma Cloud by Palo Alto Networks identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Prisma Cloud by Palo Alto Networks failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Prisma Cloud by Palo Alto Networks is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Prisma Cloud by Palo Alto Networks as the basis for migration or production guidance.
