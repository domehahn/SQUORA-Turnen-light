...
const ACTION_LABELS: Record<string, string> = {
  ...
  "member.made_springer": "als Springer markiert",
  "member.unset_springer": "Springer-Rolle aufgehoben",
  "member.made_kassenwart": "als Kassenwart markiert",
  "member.unset_kassenwart": "Kassenwart-Rolle aufgehoben",
  "hours_report.submitted": "Stundennachweis eingereicht",
  "hours_report.resubmitted": "Stundennachweis erneut eingereicht",
  "hours_report.settled": "Stundennachweis abgerechnet",
