---
name: "cncf-open-cluster-management-reviewer"
description: "Review Open Cluster Management using its official documentation and repository in the Orchestration & Management / Scheduling & Orchestration category. A lightweight, open standard for multi-cluster Kubernetes management built on a hub-spoke architecture."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Open Cluster Management Reviewer

## Purpose

Review and operate Open Cluster Management using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Open Cluster Management code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Open Cluster Management requires evidence-backed assessment.
...
- First-party source: https://github.com/open-cluster-management-io/ocm
...
- [ ] Trace Open Cluster Management inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Open Cluster Management defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Open Cluster Management least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Open Cluster Management resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Open Cluster Management release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Open Cluster Management dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Open Cluster Management identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Open Cluster Management change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Open Cluster Management documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Open Cluster Management architecture and dependency summary with trust boundaries and persistent state.
- Include Open Cluster Management validation commands or tests that are safe for the stated environment.
...
- Open Cluster Management identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Open Cluster Management failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Open Cluster Management is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Open Cluster Management as the basis for migration or production guidance.
