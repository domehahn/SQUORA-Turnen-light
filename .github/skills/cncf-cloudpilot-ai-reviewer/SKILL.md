---
name: "cncf-cloudpilot-ai-reviewer"
description: "Review CloudPilot AI using its official documentation and repository in the Observability and Analysis / Continuous Optimization category. CloudPilot AI automates Kubernetes cost optimization to reduce cloud costs up to 80%. Zero performance impact, 5-minute deployment."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Cloudpilot Ai Reviewer

## Purpose

Review and operate CloudPilot AI using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- CloudPilot AI code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving CloudPilot AI requires evidence-backed assessment.
...
- First-party source: https://www.cloudpilot.ai/
...
- [ ] Trace CloudPilot AI inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check CloudPilot AI defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check CloudPilot AI least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check CloudPilot AI resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check CloudPilot AI release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check CloudPilot AI dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If CloudPilot AI identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a CloudPilot AI change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- CloudPilot AI documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a CloudPilot AI architecture and dependency summary with trust boundaries and persistent state.
- Include CloudPilot AI validation commands or tests that are safe for the stated environment.
...
- CloudPilot AI identity, version, configuration, dependencies, and deployment assumptions are explicit.
- CloudPilot AI failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that CloudPilot AI is secure, supported, compatible, or suitable.
- Using an unpinned latest version of CloudPilot AI as the basis for migration or production guidance.
