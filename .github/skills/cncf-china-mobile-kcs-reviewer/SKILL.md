...
---
# Cncf China Mobile Kcs Reviewer

## Purpose

Review and operate China Mobile KCS using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- China Mobile KCS code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving China Mobile KCS requires evidence-backed assessment.
...
- [ ] Trace China Mobile KCS inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check China Mobile KCS defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check China Mobile KCS least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check China Mobile KCS resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check China Mobile KCS release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check China Mobile KCS dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If China Mobile KCS identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a China Mobile KCS change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- China Mobile KCS documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a China Mobile KCS architecture and dependency summary with trust boundaries and persistent state.
- Include China Mobile KCS validation commands or tests that are safe for the stated environment.
...
- China Mobile KCS identity, version, configuration, dependencies, and deployment assumptions are explicit.
- China Mobile KCS failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that China Mobile KCS is secure, supported, compatible, or suitable.
- Using an unpinned latest version of China Mobile KCS as the basis for migration or production guidance.
