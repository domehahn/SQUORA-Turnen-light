---
name: "cncf-cloud-native-landscape-reviewer"
description: "Review Cloud Native Landscape using its official documentation and repository in the Serverless / Tools category."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Cloud Native Landscape Reviewer

## Purpose

Review and operate Cloud Native Landscape using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Cloud Native Landscape code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Cloud Native Landscape requires evidence-backed assessment.
...
- CNCF classification: Serverless / Tools
- CNCF project maturity field: not specified
- First-party source: https://github.com/cncf/landscapeapp
...
- [ ] Trace Cloud Native Landscape inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Cloud Native Landscape defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Cloud Native Landscape least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Cloud Native Landscape resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Cloud Native Landscape release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Cloud Native Landscape dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Cloud Native Landscape identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Cloud Native Landscape change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Cloud Native Landscape documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Cloud Native Landscape architecture and dependency summary with trust boundaries and persistent state.
- Include Cloud Native Landscape validation commands or tests that are safe for the stated environment.
...
- Cloud Native Landscape identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Cloud Native Landscape failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Cloud Native Landscape is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Cloud Native Landscape as the basis for migration or production guidance.
