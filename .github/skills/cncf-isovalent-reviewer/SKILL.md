---
name: "cncf-isovalent-reviewer"
description: "Review Isovalent using its official documentation and repository in the Runtime / Cloud Native Network category."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Isovalent Reviewer

## Purpose

Review and operate Isovalent using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Isovalent code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Isovalent requires evidence-backed assessment.
...
- [ ] Trace Isovalent inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Isovalent defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Isovalent least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Isovalent resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Isovalent release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Isovalent dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Isovalent identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Isovalent change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Isovalent documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Isovalent architecture and dependency summary with trust boundaries and persistent state.
- Include Isovalent validation commands or tests that are safe for the stated environment.
...
- Isovalent identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Isovalent failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Isovalent is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Isovalent as the basis for migration or production guidance.
