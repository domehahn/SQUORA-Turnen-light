---
name: "cncf-red-hat-build-of-microshift-reviewer"
description: "Review Red Hat Build of Microshift using its official documentation and repository in the Platform / Certified Kubernetes - Distribution category. A component of Red Hat Device Edge used to provide lightweight Kubernetes container orchestration in field deployed devices at the far edge"
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Red Hat Build Of Microshift Reviewer

## Purpose

Review and operate Red Hat Build of Microshift using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Red Hat Build of Microshift code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Red Hat Build of Microshift requires evidence-backed assessment.
...
- First-party source: https://github.com/openshift/microshift
...
- [ ] Trace Red Hat Build of Microshift inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Red Hat Build of Microshift defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Red Hat Build of Microshift least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Red Hat Build of Microshift resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Red Hat Build of Microshift release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Red Hat Build of Microshift dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Red Hat Build of Microshift identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Red Hat Build of Microshift change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Red Hat Build of Microshift documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Red Hat Build of Microshift architecture and dependency summary with trust boundaries and persistent state.
- Include Red Hat Build of Microshift validation commands or tests that are safe for the stated environment.
...
- Red Hat Build of Microshift identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Red Hat Build of Microshift failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Red Hat Build of Microshift is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Red Hat Build of Microshift as the basis for migration or production guidance.
