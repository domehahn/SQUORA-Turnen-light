---
name: "cncf-intersystems-iris-data-platform-reviewer"
description: "Review InterSystems IRIS Data Platform using its official documentation and repository in the App Definition and Development / Database category."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Intersystems Iris Data Platform Reviewer

## Purpose

Review and operate InterSystems IRIS Data Platform using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- InterSystems IRIS Data Platform code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving InterSystems IRIS Data Platform requires evidence-backed assessment.
...
- CNCF classification: App Definition and Development / Database
- CNCF project maturity field: not specified
- First-party source: https://www.intersystems.com/products/intersystems-iris/
...
- [ ] Trace InterSystems IRIS Data Platform inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check InterSystems IRIS Data Platform defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check InterSystems IRIS Data Platform least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check InterSystems IRIS Data Platform resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check InterSystems IRIS Data Platform release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check InterSystems IRIS Data Platform dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If InterSystems IRIS Data Platform identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a InterSystems IRIS Data Platform change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- InterSystems IRIS Data Platform documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a InterSystems IRIS Data Platform architecture and dependency summary with trust boundaries and persistent state.
- Include InterSystems IRIS Data Platform validation commands or tests that are safe for the stated environment.
...
- InterSystems IRIS Data Platform identity, version, configuration, dependencies, and deployment assumptions are explicit.
- InterSystems IRIS Data Platform failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that InterSystems IRIS Data Platform is secure, supported, compatible, or suitable.
- Using an unpinned latest version of InterSystems IRIS Data Platform as the basis for migration or production guidance.
