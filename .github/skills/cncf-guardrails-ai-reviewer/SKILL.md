---
name: "cncf-guardrails-ai-reviewer"
description: "Review Guardrails AI using its official documentation and repository in the AI Agent / Guardrail category. Adding guardrails to large language models."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Guardrails Ai Reviewer

## Purpose

Review and operate Guardrails AI using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Guardrails AI code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Guardrails AI requires evidence-backed assessment.
...
- First-party source: https://github.com/guardrails-ai/guardrails
...
- [ ] Trace Guardrails AI inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Guardrails AI defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Guardrails AI least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Guardrails AI resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Guardrails AI release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Guardrails AI dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Guardrails AI identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Guardrails AI change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Guardrails AI documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Guardrails AI architecture and dependency summary with trust boundaries and persistent state.
- Include Guardrails AI validation commands or tests that are safe for the stated environment.
...
- Guardrails AI identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Guardrails AI failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Guardrails AI is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Guardrails AI as the basis for migration or production guidance.
