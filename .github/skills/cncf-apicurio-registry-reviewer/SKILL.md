---
name: "cncf-apicurio-registry-reviewer"
description: "Review Apicurio Registry using its official documentation and repository in the App Definition and Development / Streaming & Messaging category. Apicurio Registry is a runtime server system that stores a specific set of artifacts as files."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Apicurio Registry Reviewer

## Purpose

Review and operate Apicurio Registry using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Apicurio Registry code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Apicurio Registry requires evidence-backed assessment.
...
- CNCF classification: App Definition and Development / Streaming & Messaging
- CNCF project maturity field: sandbox
- First-party source: https://github.com/Apicurio/apicurio-registry
...
- [ ] Trace Apicurio Registry inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Apicurio Registry defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Apicurio Registry least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Apicurio Registry resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Apicurio Registry release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Apicurio Registry dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Apicurio Registry identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Apicurio Registry change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Apicurio Registry documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Apicurio Registry architecture and dependency summary with trust boundaries and persistent state.
- Include Apicurio Registry validation commands or tests that are safe for the stated environment.
...
- Apicurio Registry identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Apicurio Registry failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Apicurio Registry is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Apicurio Registry as the basis for migration or production guidance.
