...
---
# Cncf Tencent Cloud Serverless Cloud Function Reviewer

## Purpose

Review and operate Tencent Cloud Serverless Cloud Function using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Tencent Cloud Serverless Cloud Function code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Tencent Cloud Serverless Cloud Function requires evidence-backed assessment.
...
- First-party source: https://cloud.tencent.com/product/scf
...
- [ ] Trace Tencent Cloud Serverless Cloud Function inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Tencent Cloud Serverless Cloud Function defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Tencent Cloud Serverless Cloud Function least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Tencent Cloud Serverless Cloud Function resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Tencent Cloud Serverless Cloud Function release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Tencent Cloud Serverless Cloud Function dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Tencent Cloud Serverless Cloud Function identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Tencent Cloud Serverless Cloud Function change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Tencent Cloud Serverless Cloud Function documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Tencent Cloud Serverless Cloud Function architecture and dependency summary with trust boundaries and persistent state.
- Include Tencent Cloud Serverless Cloud Function validation commands or tests that are safe for the stated environment.
...
- Tencent Cloud Serverless Cloud Function identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Tencent Cloud Serverless Cloud Function failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Tencent Cloud Serverless Cloud Function is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Tencent Cloud Serverless Cloud Function as the basis for migration or production guidance.
