...
---
# Cncf Wind River Studio Cloud Platform Reviewer

## Purpose

Review and operate Wind River Studio Cloud Platform using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Wind River Studio Cloud Platform code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Wind River Studio Cloud Platform requires evidence-backed assessment.
...
- First-party source: https://github.com/wind-river/starlingx-config
...
- [ ] Trace Wind River Studio Cloud Platform inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Wind River Studio Cloud Platform defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Wind River Studio Cloud Platform least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Wind River Studio Cloud Platform resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Wind River Studio Cloud Platform release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Wind River Studio Cloud Platform dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Wind River Studio Cloud Platform identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Wind River Studio Cloud Platform change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Wind River Studio Cloud Platform documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Wind River Studio Cloud Platform architecture and dependency summary with trust boundaries and persistent state.
- Include Wind River Studio Cloud Platform validation commands or tests that are safe for the stated environment.
...
- Wind River Studio Cloud Platform identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Wind River Studio Cloud Platform failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Wind River Studio Cloud Platform is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Wind River Studio Cloud Platform as the basis for migration or production guidance.
