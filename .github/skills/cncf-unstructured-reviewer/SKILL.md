---
name: "cncf-unstructured-reviewer"
description: "Review Unstructured using its official documentation and repository in the AI Agent / RAG category. Convert documents to structured data effortlessly. Unstructured is open-source ETL solution for transforming complex documents into clean, structured formats for language models. Visit our website to learn more about our enterprise grade Platform product for production grade workflows, partitioning, enrichments, chunking and embedding."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Unstructured Reviewer

## Purpose

Review and operate Unstructured using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Unstructured code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Unstructured requires evidence-backed assessment.
...
- CNCF classification: AI Agent / RAG
- CNCF project maturity field: not specified
- First-party source: https://github.com/Unstructured-IO/unstructured
...
- [ ] Trace Unstructured inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Unstructured defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Unstructured least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Unstructured resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Unstructured release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Unstructured dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Unstructured identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Unstructured change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Unstructured documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Unstructured architecture and dependency summary with trust boundaries and persistent state.
- Include Unstructured validation commands or tests that are safe for the stated environment.
...
- Unstructured identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Unstructured failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Unstructured is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Unstructured as the basis for migration or production guidance.
