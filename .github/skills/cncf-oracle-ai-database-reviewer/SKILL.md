...
---
# Cncf Oracle Ai Database Reviewer

## Purpose

Review and operate Oracle AI Database using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Oracle AI Database code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Oracle AI Database requires evidence-backed assessment.
...
- First-party source: https://www.oracle.com/database/
...
- [ ] Trace Oracle AI Database inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Oracle AI Database defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Oracle AI Database least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Oracle AI Database resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Oracle AI Database release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Oracle AI Database dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Oracle AI Database identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Oracle AI Database change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Oracle AI Database documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Oracle AI Database architecture and dependency summary with trust boundaries and persistent state.
- Include Oracle AI Database validation commands or tests that are safe for the stated environment.
...
- Oracle AI Database identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Oracle AI Database failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Oracle AI Database is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Oracle AI Database as the basis for migration or production guidance.
