---
name: "cncf-blue-matador-reviewer"
description: "Review Blue Matador using its official documentation and repository in the Observability and Analysis / Observability category."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Blue Matador Reviewer

## Purpose

Review and operate Blue Matador using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Blue Matador code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Blue Matador requires evidence-backed assessment.
...
- First-party source: https://www.bluematador.com
...
- [ ] Trace Blue Matador inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Blue Matador defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Blue Matador least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Blue Matador resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Blue Matador release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Blue Matador dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Blue Matador identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Blue Matador change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Blue Matador documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Blue Matador architecture and dependency summary with trust boundaries and persistent state.
- Include Blue Matador validation commands or tests that are safe for the stated environment.
...
- Blue Matador identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Blue Matador failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Blue Matador is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Blue Matador as the basis for migration or production guidance.
