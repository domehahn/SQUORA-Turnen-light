---
name: "cncf-apache-zeppelin-reviewer"
description: "Review Apache Zeppelin using its official documentation and repository in the Data / Data Science category. Web-based notebook that enables data-driven, interactive data analytics and collaborative documents with SQL, Scala and more."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Apache Zeppelin Reviewer

## Purpose

Review and operate Apache Zeppelin using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Apache Zeppelin code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Apache Zeppelin requires evidence-backed assessment.
...
- CNCF classification: Data / Data Science
- CNCF project maturity field: not specified
- First-party source: https://github.com/apache/zeppelin
...
- [ ] Trace Apache Zeppelin inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Apache Zeppelin defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Apache Zeppelin least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Apache Zeppelin resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Apache Zeppelin release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Apache Zeppelin dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Apache Zeppelin identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Apache Zeppelin change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Apache Zeppelin documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Apache Zeppelin architecture and dependency summary with trust boundaries and persistent state.
- Include Apache Zeppelin validation commands or tests that are safe for the stated environment.
...
- Apache Zeppelin identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Apache Zeppelin failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Apache Zeppelin is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Apache Zeppelin as the basis for migration or production guidance.
