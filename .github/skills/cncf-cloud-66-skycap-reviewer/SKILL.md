---
name: "cncf-cloud-66-skycap-reviewer"
description: "Review Cloud 66 Skycap using its official documentation and repository in the App Definition and Development / Continuous Integration & Delivery category. Skycap is the easiest way to deploy and run applications on any existing Kubernetes cluster."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Cloud 66 Skycap Reviewer

## Purpose

Review and operate Cloud 66 Skycap using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Cloud 66 Skycap code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Cloud 66 Skycap requires evidence-backed assessment.
...
- [ ] Trace Cloud 66 Skycap inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Cloud 66 Skycap defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Cloud 66 Skycap least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Cloud 66 Skycap resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Cloud 66 Skycap release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Cloud 66 Skycap dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Cloud 66 Skycap identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Cloud 66 Skycap change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Cloud 66 Skycap documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Cloud 66 Skycap architecture and dependency summary with trust boundaries and persistent state.
- Include Cloud 66 Skycap validation commands or tests that are safe for the stated environment.
...
- Cloud 66 Skycap identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Cloud 66 Skycap failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Cloud 66 Skycap is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Cloud 66 Skycap as the basis for migration or production guidance.
