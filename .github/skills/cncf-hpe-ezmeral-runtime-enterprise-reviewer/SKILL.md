...
---
# Cncf Hpe Ezmeral Runtime Enterprise Reviewer

## Purpose

Review and operate HPE Ezmeral Runtime Enterprise using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- HPE Ezmeral Runtime Enterprise code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving HPE Ezmeral Runtime Enterprise requires evidence-backed assessment.
...
- [ ] Trace HPE Ezmeral Runtime Enterprise inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check HPE Ezmeral Runtime Enterprise defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check HPE Ezmeral Runtime Enterprise least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check HPE Ezmeral Runtime Enterprise resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check HPE Ezmeral Runtime Enterprise release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check HPE Ezmeral Runtime Enterprise dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If HPE Ezmeral Runtime Enterprise identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a HPE Ezmeral Runtime Enterprise change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- HPE Ezmeral Runtime Enterprise documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a HPE Ezmeral Runtime Enterprise architecture and dependency summary with trust boundaries and persistent state.
- Include HPE Ezmeral Runtime Enterprise validation commands or tests that are safe for the stated environment.
...
- HPE Ezmeral Runtime Enterprise identity, version, configuration, dependencies, and deployment assumptions are explicit.
- HPE Ezmeral Runtime Enterprise failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that HPE Ezmeral Runtime Enterprise is secure, supported, compatible, or suitable.
- Using an unpinned latest version of HPE Ezmeral Runtime Enterprise as the basis for migration or production guidance.
