---
name: "cncf-wso2-api-microgateway-reviewer"
description: "Review WSO2 API Microgateway using its official documentation and repository in the Orchestration & Management / API Gateway category."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Wso2 Api Microgateway Reviewer

## Purpose

Review and operate WSO2 API Microgateway using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- WSO2 API Microgateway code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving WSO2 API Microgateway requires evidence-backed assessment.
...
- First-party source: https://github.com/wso2/product-microgateway
...
- [ ] Trace WSO2 API Microgateway inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check WSO2 API Microgateway defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check WSO2 API Microgateway least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check WSO2 API Microgateway resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check WSO2 API Microgateway release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check WSO2 API Microgateway dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If WSO2 API Microgateway identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a WSO2 API Microgateway change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- WSO2 API Microgateway documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a WSO2 API Microgateway architecture and dependency summary with trust boundaries and persistent state.
- Include WSO2 API Microgateway validation commands or tests that are safe for the stated environment.
...
- WSO2 API Microgateway identity, version, configuration, dependencies, and deployment assumptions are explicit.
- WSO2 API Microgateway failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that WSO2 API Microgateway is secure, supported, compatible, or suitable.
- Using an unpinned latest version of WSO2 API Microgateway as the basis for migration or production guidance.
