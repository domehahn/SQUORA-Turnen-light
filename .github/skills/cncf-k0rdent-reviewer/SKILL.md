---
name: "cncf-k0rdent-reviewer"
description: "Review k0rdent using its official documentation and repository in the Orchestration & Management / Scheduling & Orchestration category. k0rdent is an open-source, Kubernetes-native distributed container management environment for platform engineers."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf K0rdent Reviewer

## Purpose

Review and operate k0rdent using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- k0rdent code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving k0rdent requires evidence-backed assessment.
...
- CNCF classification: Orchestration & Management / Scheduling & Orchestration; Platform / Certified Kubernetes - Distribution
- CNCF project maturity field: not specified
- First-party source: https://github.com/k0rdent/k0rdent
...
- [ ] Trace k0rdent inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check k0rdent defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check k0rdent least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check k0rdent resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check k0rdent release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check k0rdent dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If k0rdent identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a k0rdent change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- k0rdent documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a k0rdent architecture and dependency summary with trust boundaries and persistent state.
- Include k0rdent validation commands or tests that are safe for the stated environment.
...
- k0rdent identity, version, configuration, dependencies, and deployment assumptions are explicit.
- k0rdent failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that k0rdent is secure, supported, compatible, or suitable.
- Using an unpinned latest version of k0rdent as the basis for migration or production guidance.
