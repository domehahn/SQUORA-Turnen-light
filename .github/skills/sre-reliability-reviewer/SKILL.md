...
1. Identify the relevant SRE reliability artifacts, owners, systems, environments, and review boundary.
2. Compare the available artifacts against expected signals such as burn-rate alert, latency percentile, saturation metric, incident trend, chaos test result, runbook.
