---
name: "cncf-idem-project-reviewer"
description: "Review Idem Project using its official documentation and repository in the Provisioning / Automation & Configuration category. Idem reduces your cloud configuration to data – for you! Instead of Infrastructure as Code, Idem delivers Infrastructure as Data. The cloud becomes simplified, easier to maintain, easier to discover, and easier to use."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Idem Project Reviewer

## Purpose

Review and operate Idem Project using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Idem Project code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Idem Project requires evidence-backed assessment.
...
- First-party source: https://www.idemproject.io
...
- [ ] Trace Idem Project inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Idem Project defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Idem Project least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Idem Project resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Idem Project release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Idem Project dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Idem Project identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Idem Project change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Idem Project documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Idem Project architecture and dependency summary with trust boundaries and persistent state.
- Include Idem Project validation commands or tests that are safe for the stated environment.
...
- Idem Project identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Idem Project failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Idem Project is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Idem Project as the basis for migration or production guidance.
