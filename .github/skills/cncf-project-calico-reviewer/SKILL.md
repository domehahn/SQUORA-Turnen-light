---
name: "cncf-project-calico-reviewer"
description: "Review Project Calico using its official documentation and repository in the Runtime / Cloud Native Network category."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Project Calico Reviewer

## Purpose

Review and operate Project Calico using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Project Calico code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Project Calico requires evidence-backed assessment.
...
- First-party source: https://github.com/projectcalico/calico
...
- [ ] Trace Project Calico inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Project Calico defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Project Calico least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Project Calico resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Project Calico release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Project Calico dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Project Calico identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Project Calico change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Project Calico documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Project Calico architecture and dependency summary with trust boundaries and persistent state.
- Include Project Calico validation commands or tests that are safe for the stated environment.
...
- Project Calico identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Project Calico failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Project Calico is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Project Calico as the basis for migration or production guidance.
