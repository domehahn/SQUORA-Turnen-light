---
name: "cncf-baidu-cloud-container-engine-reviewer"
description: "Review Baidu Cloud Container Engine using its official documentation and repository in the Platform / Certified Kubernetes - Hosted category. Baidu Cloud Container Engine, aka CCE."
version: "0.1.0"
since: "2026-08-27"
...
---
# Cncf Baidu Cloud Container Engine Reviewer

## Purpose

Review and operate Baidu Cloud Container Engine using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- Baidu Cloud Container Engine code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving Baidu Cloud Container Engine requires evidence-backed assessment.
...
- First-party source: https://cloud.baidu.com/product/cce.html
...
- [ ] Trace Baidu Cloud Container Engine inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check Baidu Cloud Container Engine defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check Baidu Cloud Container Engine least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check Baidu Cloud Container Engine resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check Baidu Cloud Container Engine release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check Baidu Cloud Container Engine dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If Baidu Cloud Container Engine identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a Baidu Cloud Container Engine change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- Baidu Cloud Container Engine documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a Baidu Cloud Container Engine architecture and dependency summary with trust boundaries and persistent state.
- Include Baidu Cloud Container Engine validation commands or tests that are safe for the stated environment.
...
- Baidu Cloud Container Engine identity, version, configuration, dependencies, and deployment assumptions are explicit.
- Baidu Cloud Container Engine failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that Baidu Cloud Container Engine is secure, supported, compatible, or suitable.
- Using an unpinned latest version of Baidu Cloud Container Engine as the basis for migration or production guidance.
