...
---
# Cncf Softbank Infrinia Ai Cloud Os Reviewer

## Purpose

Review and operate SoftBank Infrinia AI Cloud OS using current official documentation, repository evidence, and its CNCF Landscape classification without treating Landscape inclusion as endorsement.
...
- SoftBank Infrinia AI Cloud OS code, configuration, APIs, deployment, integrations, dependencies, upgrades, or operations are in scope.
- A technology choice or migration involving SoftBank Infrinia AI Cloud OS requires evidence-backed assessment.
...
- First-party source: https://www.infrinia.ai
...
- [ ] Trace SoftBank Infrinia AI Cloud OS inputs, outputs, identities, trust boundaries, external dependencies, and persistent state.
- [ ] Check SoftBank Infrinia AI Cloud OS defaults, configuration precedence, environment separation, and drift from reviewed source.
- [ ] Check SoftBank Infrinia AI Cloud OS least privilege, credential rotation, audit events, policy enforcement, and break-glass behavior.
- [ ] Check SoftBank Infrinia AI Cloud OS resource ownership, cleanup, quotas, rate limits, timeouts, retries, and backpressure.
- [ ] Check SoftBank Infrinia AI Cloud OS release notes, supported upgrade paths, schema or API compatibility, and rollback constraints.
- [ ] Check SoftBank Infrinia AI Cloud OS dashboards, alerts, health signals, incident procedures, backup evidence, and recovery exercises.
...
- If SoftBank Infrinia AI Cloud OS identity, version, edition, or deployment model cannot be established, report the uncertainty before recommending a change.
- If a SoftBank Infrinia AI Cloud OS change can affect availability, security boundaries, persistent data, or external consumers, require staged validation and explicit rollback criteria.
...
- SoftBank Infrinia AI Cloud OS documentation, ownership, maintenance, licensing, provenance, or evidence gap.
...
- Include a SoftBank Infrinia AI Cloud OS architecture and dependency summary with trust boundaries and persistent state.
- Include SoftBank Infrinia AI Cloud OS validation commands or tests that are safe for the stated environment.
...
- SoftBank Infrinia AI Cloud OS identity, version, configuration, dependencies, and deployment assumptions are explicit.
- SoftBank Infrinia AI Cloud OS failure, upgrade, rollback, observability, and recovery paths have proportionate evidence.
...
- Assuming Landscape inclusion or popularity proves that SoftBank Infrinia AI Cloud OS is secure, supported, compatible, or suitable.
- Using an unpinned latest version of SoftBank Infrinia AI Cloud OS as the basis for migration or production guidance.
